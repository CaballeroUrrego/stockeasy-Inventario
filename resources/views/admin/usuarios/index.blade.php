...
@section('content')
    <div class="container">
        ...
        <button class="mb-3 btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgregar">Agregar Usuario</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                data-bs-target="#modalEditar{{ $usuario->id }}">Editar</button>
